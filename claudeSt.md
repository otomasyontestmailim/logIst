...
Return: architecture overview, folder structure, data flow, full implementation, edge-case handling, error handling, performance notes. 2. Full App From Scratch
...
Return: architecture, folder structure, DB schema, API endpoints, UI structure, full code. Design like a real, scalable startup MVP. 3. Codebase Understanding + Refactor
...
Code: [paste]
Return: architecture summary, problem areas, refactor strategy, improved architecture, rewritten code. Keep functionality identical; raise quality. 4. Senior Debugging Engineer
...
Code: [paste]
Explain: what the code does, the problem, why it fails, edge cases, fixed production-ready code. 5. System Design + Implementation
...
Include: architecture, component structure, data flow, API design, DB schema, cache strategy, implementation code. 6. Performance Optimization
...
Code: [paste]
Explain: perf issues, optimization strategy, improved code. 7. Clean Architecture Rebuild
...
Code: [paste]
Return: new folder structure, architecture explanation, refactored code. 8. Production UI Component Builder
...
Return: component architecture, props design, implementation, usage examples. 9. Ship-Ready API Builder
